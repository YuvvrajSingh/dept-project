...
const subjectsRaw = [
  ...
  {
    code: "6CSE11B",
    name: "Neural Networks Laboratory",
    type: "LAB",
    creditHours: 2,
  },
  {
  ...
  {
    code: "4ADS35A",
    name: "Fundamentals of Statistical Inference",
    type: "THEORY",
    creditHours: 3,
  },
  {
  ...
  {
    code: "4ADS35B",
    name: "Statistical Inference using Python Laboratory",
    type: "LAB",
    creditHours: 3,
  },
  {
  ...
  {
    code: "4IT45B",
    name: "Computer Organization and Architecture Laboratory",
    type: "LAB",
    creditHours: 2,
  },
  {
    code: "6IT41A",
    name: "Robotics and Embedded System",
    type: "THEORY",
    creditHours: 3,
  },
  {
  ...
  {
    code: "6CSE41B",
    name: "Robotics and Embedded System Laboratory",
    type: "LAB",
    creditHours: 2,
  },
  {
    code: "6IT52B",
    name: "Modern Web Development Laboratory",
    type: "LAB",
    creditHours: 2,
  },
  {
  ...
  {
    code: "6CSE53B",
    name: "Advanced Machine Learning Laboratory",
    type: "LAB",
    creditHours: 2,
  },
  {
...
async function main() {
  ...
  const subjectByCode = Object.fromEntries(
    subjectsInDb.map((s) => [s.code, s.id]),
  );

  const teachersInDb = await prisma.teacher.findMany();
  const teacherByAbbr = Object.fromEntries(
    teachersInDb.map((t) => [t.abbreviation, t.id]),
  );
  ...
  const adsBranchName =
    branchNames.find((b) => ["ADS", "AI", "AID"].includes(b)) || "ADS";
  ...
  for (const cls of activeClasses) {
    ...
    const branchName =
      cls.branch.name === adsBranchName ? "ADS" : cls.branch.name;
    ...
    for (const rawCode of codes) {
      ...
      try {
        await prisma.classSubject.upsert({
          where: {
            classSectionId_subjectId: { classSectionId: cls.id, subjectId },
          },
          update: {},
